...
plot(agnes_hc_single, 
     main = "Customer Ratings of Cereals - AGNES - Single Linkage Method",
     xlab = "Cereal",
     ylab = "Height",
     cex.axis = 1,
     cex = 0.50)
...
plot(agnes_hc_complete, 
     main = "Customer Ratings of Cereals - AGNES - Complete Linkage Method",
     xlab = "Cereal",
     ylab = "Height",
     cex.axis = 1,
     cex = 0.50)
...
# Plot the results of the different methods
plot(agnes_hc_ward, 
     main = "Customer Ratings of Cereal - AGNES - Ward Linkage Method",
     xlab = "Cereal",
     ylab = "Height",
     cex.axis = 1,
     cex = 0.50)
